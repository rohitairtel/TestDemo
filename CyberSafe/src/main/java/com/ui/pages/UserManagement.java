...
public class UserManagement {
	...
	public  void createUserLandingPage() throws Exception {
		...
		TestConstant.userHeaderClick = TestConstant.driver.findElement(By
				.xpath(utility.ConfigurationFile.getProperty(TestConstant.userHeaderClickElementFiled)));
		...
		TestConstant.userSubMenuHeader = TestConstant.driver.findElement(By.xpath(
				utility.ConfigurationFile.getProperty(TestConstant.userSubMenuHeaderClickElementFiled)));
	...
	public void createUserForm() throws Exception {
		...
		TestConstant.userCreateTab = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userCreateTabElementField)));
		...
		TestConstant.userFirstName = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userFirstNameElementField)));
		...
		TestConstant.userLastName = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userLastNameElementField)));
		...
		TestConstant.userEmail = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userEmailElementField)));
		...
		TestConstant.description = TestConstant.driver.findElement(By
				.xpath(utility.ConfigurationFile.getProperty(TestConstant.UserDescriptionElementField)));
		...
		TestConstant.userMobile = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userMobileElementField)));
		...
		TestConstant.userEntityName = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userEntityNameElementField)));
		...
		TestConstant.entitySaveButton = TestConstant.driver.findElement(
				By.xpath(utility.ConfigurationFile.getProperty(TestConstant.userSaveButtonElementField)));
